...
LOG_DIR = "//ads.warwick.ac.uk/shared/HCSS6/Shared305/Microscopy/Jeffrey-Ede/models/modified_losses/experiments7/"
CIFAR10_DIR = "//ads.warwick.ac.uk/shared/HCSS6/Shared305/Microscopy/Jeffrey-Ede/models/modified_losses/cifar10-7/"
NUM_REPEATS = 1
MOMENT_DECAY = 0.999
...
for repeat_num in range(NUM_REPEATS):
    for num_stddev in [0, 2]:
        for initial_lr in [0.0001, 0.003]:
