...
tf.app.flags.DEFINE_string('log_file', '/tmp/cifar10_train/log.txt', 
...
INITIAL_LEARNING_RATE = 0.1/128 # Initial learning rate.
...
def inference(images):
    ...
    loss = 25 * tf.reduce_mean((images-x)**4, axis=[1,2,3])
